...
class Prop21(Book1Scene):
    ...
    def go(self):
        ...
        eq[2] = t2.math(r'c_1 + b_3 + b_4 >\ c_2 + c_3 + b_4',
                        ...
                        delay_anim=False)
        eq[2][1].align_to(eq[1].parts[1], LEFT)
        self.next_page()
        ...
        with self.simultaneous():
            t2.e_fade()
            t2.e_normal(0)
            t2.e_normal(slice(-3,-1))
        eq[3] = t2.math(r'c_1 + b_1 >\ c_2 + c_3 + b_4',
                        break_into_parts=('c_1 + b_1', r'>\ c_2 + c_3 + b_4'),
                        delay_anim=True)
        eq[3][1].align_to(eq[1][1], LEFT)
        with self.simultaneous():
            eq[3].parts[0].transform_from(eq[2].parts[0])
            eq[3].parts[1].transform_from(eq[2].parts[1])
        ...
        with self.simultaneous():
            eq[5] = t2.math(r'c_2 + c_3 + b_4\ >\ c_2 + b_2',
                            ...
                            align_str=r'c_3 + b_4\ >',
                            delay_anim=False)
            eq[5].parts[1].align_to(eq[4].parts[1], RIGHT)
        self.next_page()
        ...
        with self.simultaneous(run_time=1):
            t2.e_fade()
            eq[3].parts[0].e_normal()
            eq[3].parts[1].e_normal()
            eq[5].parts[0].e_normal()
            eq[5].parts[1].e_normal()
        ...
        eq[6] = t2.math(r'c_1 + b_1\ >\ c_2 + b_2',
                        ...
                        align_str=r'>',
                        delay_anim=True)
        left, op, right = eq[6].parts
        self.wait(0.5)
        with self.simultaneous(run_time=2):
            left.transform_from(eq[3].parts[0])
            right.transform_from(eq[5].parts[1])
            op.transform_from(mn.VGroup(
                eq[3].parts[1]['c_2 + c_3 + b_4'],
                eq[5].parts[0]['c_2 + c_3 + b_4'],
            ))
        ...
        with self.simultaneous():
            t2.e_fade()
            eq[6].parts[0].blue.e_normal()
            eq[6].parts[1].blue.e_normal()
            eq[6].parts[2].blue.e_normal()
        ...
        with self.delayed():
            ...
            eq[6].parts[2].e_normal()
            eq[9].parts[0].blue.e_normal()
            eq[9].parts[1].blue.e_normal()
            eq[9].parts[2].blue.e_normal()
