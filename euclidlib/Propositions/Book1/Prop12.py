...
class Prop12(Book1Scene):
    ...
    def define_steps(self):
        ...
        def _p2():
            ...
            l['CE'] = ELine('CE', label=('r_1', dict(outside=True)))
            l['CF'] = ELine('CF', label=('r_1', dict(inside=True)))
        ...
        def _p5():
            ...
            nonlocal l
            with self.simultaneous():
                a['ECG'] = EAngle('ECG', label=r'\alpha', size=mn_scale(30))
                a['FCG'] = EAngle('FCG', label=r'\alpha')
                a['CEG'] = EAngle('CEG', label=r'\beta', size=mn_scale(20))
                a['CFG'] = EAngle('CFG', label=r'\beta', size=mn_scale(30))
                a['CGE'] = EAngle('CGE', label=r'\gamma', size=mn_scale(30))
                a['CGF'] = EAngle('CGF', label=r'\gamma')
