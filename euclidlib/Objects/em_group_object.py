...
'''.strip())
    ...
    if TYPE_CHECKING:
        def blue(self, index:((int|slice)| tuple[(int|slice),...])=None)-> EIndexedGroup|EMObject: ...
        def green(self, index:((int|slice)| tuple[(int|slice),...])=None)-> EIndexedGroup|EMObject: ...
        def red(self, index:((int|slice)| tuple[(int|slice),...])=None)-> EIndexedGroup|EMObject: ...
        def white(self, index:((int|slice)| tuple[(int|slice),...])=None)-> EIndexedGroup|EMObject: ...
        def grey(self, index:((int|slice)| tuple[(int|slice),...])=None)-> EIndexedGroup|EMObject: ...
        def e_fade(self, index:((int|slice)| tuple[(int|slice),...])=None)-> EIndexedGroup|EMObject: ...
        def e_normal(self, index:((int|slice)| tuple[(int|slice),...])=None)-> EIndexedGroup|EMObject: ...
        def lift(self, index:((int|slice)| tuple[(int|slice),...])=None)-> EIndexedGroup|EMObject: ...
        def notice(self, index:((int|slice)| tuple[(int|slice),...])=None)-> EIndexedGroup|EMObject: ...
